...
const Message = () => {
  const { themeColor,handleCloseClick,isClicked } = useStateContext();

  return (
    <div className="nav-item absolute right-5 md:right-52 top-16 z-50 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
